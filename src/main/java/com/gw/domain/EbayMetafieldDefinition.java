...
public enum EbayMetafieldDefinition {
    ...
    DIAL("dial", "Dial", "Dial information for eBay listings", "multi_line_text_field"),
    STRAP("strap", "Strap/Bracelet", "Strap or bracelet information for eBay listings", "multi_line_text_field"),
