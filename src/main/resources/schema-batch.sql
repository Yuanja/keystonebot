...
-- Check if BATCH_STEP_EXECUTION_SEQ table exists
...
-- Check if BATCH_JOB_EXECUTION_SEQ table exists
...
-- Check if BATCH_JOB_SEQ table exists
...
-- Initialize sequence tables if empty
